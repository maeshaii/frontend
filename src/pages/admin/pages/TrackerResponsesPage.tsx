            ...
            <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              ...
              <div style={{ 
                ...
                <div style={{ fontSize: '12px', color: '#6b7280', marginBottom: '12px' }}>
                  Points earned from each action
                </div>
                
                {/* Likes */}
                {(() => {
                  const count = selectedUser.points_breakdown?.likes?.count || 0;
                  ...
                  return (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#374151' }}>Likes</span>
                ...
                {/* Comments */}
                {(() => {
                  const count = selectedUser.points_breakdown?.comments?.count || 0;
                  ...
                  return (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#374151' }}>Comments</span>
                        <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                          ({count})
                        </span>
                      </div>
                ...
                {/* Repost */}
                {(() => {
                  const count = selectedUser.points_breakdown?.shares?.count || 0;
                  ...
                  return (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#374151' }}>Repost</span>
                        <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                          ({count})
                        </span>
                      </div>
                ...
                {/* Replies */}
                {(() => {
                  const count = selectedUser.points_breakdown?.replies?.count || 0;
                  ...
                  return (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#374151' }}>Replies</span>
                        <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                          ({count})
                        </span>
                      </div>
                ...
                {/* Posts */}
                {(() => {
                  const count = selectedUser.points_breakdown?.posts?.count || 0;
                  ...
                  return (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#374151' }}>Posts</span>
                        <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                          ({count})
                        </span>
                      </div>
                ...
                {/* Posts with Photos */}
                {(() => {
                  const count = selectedUser.points_breakdown?.posts_with_photos?.count || 0;
                  ...
                  return (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#374151' }}>Posts w/ Photos</span>
                        <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                          ({count})
                        </span>
                      </div>
                ...
                {/* Tracker Form */}
                {(() => {
                  const count = selectedUser.points_breakdown?.tracker_form?.count || 0;
                  ...
                  return (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#374151' }}>Tracker Form</span>
                        <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                          ({count})
                        </span>
                      </div>
              ...
              <div style={{ 
                ...
                <div style={{
                  ...
                  <div style={{ fontWeight: '600', color: '#667eea', fontSize: '13px' }}>
                    +{pointsSettings.like}
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ fontWeight: '600', color: '#667eea', fontSize: '13px' }}>
                    +{pointsSettings.post_with_photo}
                  </div>
                </div>
